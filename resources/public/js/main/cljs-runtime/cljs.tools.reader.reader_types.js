...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_44272 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_44272(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_44274 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_44274(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_44275 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_44275(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_44280 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_44280(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_44288 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_44288(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_44293 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_44293(reader);
}
});
...
var G__44442 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__44443 = s.append(c);
c = G__44442;
s = G__44443;
continue;
}
