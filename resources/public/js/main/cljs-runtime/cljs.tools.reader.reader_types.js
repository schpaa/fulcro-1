...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_45344 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_45344(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_45354 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_45354(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_45355 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_45355(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_45356 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_45356(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_45357 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_45357(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_45371 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_45371(reader);
}
});
...
var G__45404 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__45405 = s.append(c);
c = G__45404;
s = G__45405;
continue;
}
