...
var o41795 = temp__5733__auto__;
var temp__5733__auto____$1 = (o41795["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o41796 = temp__5733__auto____$1;
return (o41796["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__41062__auto__ = f;
return (o__41062__auto__["toString"]).call(o__41062__auto__);
} else {
return "";
}
...
try{var o__41062__auto___41982 = t;
(o__41062__auto___41982["cljs$lang$ctorPrWriter"]).call(o__41062__auto___41982,t,writer);
}catch (e41807){var __41983 = e41807;
}
...
var char_code = (function (){var o__41062__auto__ = (new String(char$));
return (o__41062__auto__["charCodeAt"]).call(o__41062__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__41062__auto__ = String;
return (o__41062__auto__["fromCharCode"]).call(o__41062__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__41813 = num_code;
switch (G__41813) {
case (1):
return (185);
...
var o__41062__auto__ = String;
return (o__41062__auto__["fromCharCode"]).call(o__41062__auto__,superscript_code);
});
/**
...
}catch (e41823){var _e__41078__auto__ = e41823;
return false;
}})())){
...
var vec__41824 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41824,(0),null);
...
var len__4736__auto___42010 = arguments.length;
var i__4737__auto___42011 = (0);
while(true){
if((i__4737__auto___42011 < len__4736__auto___42010)){
args__4742__auto__.push((arguments[i__4737__auto___42011]));

var G__42013 = (i__4737__auto___42011 + (1));
i__4737__auto___42011 = G__42013;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__41840){
var vec__41841 = p__41840;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41841,(0),null);
...
var G__42016 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__42017 = cljs.core.butlast(remaining_tokens);
name_tokens = G__42016;
remaining_tokens = G__42017;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq41836){
var G__41837 = cljs.core.first(seq41836);
var seq41836__$1 = cljs.core.next(seq41836);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41837,seq41836__$1);
}));
...
var vec__41847 = cljs.core.split_with((function (p1__41846_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__41846_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41847,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41847,(1),null);
...
var vec__41853 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41853,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41853,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__42028 = cljs.core.rest(remaining_tokens);
var G__42029 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__42028;
name_tokens = G__42029;
continue;
} else {
...
var vec__41859 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41859,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41859,(1),null);
var vec__41862 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41862,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41862,(1),null);
var vec__41865 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41865,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41865,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41865,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41865,(3),null);
...
var vec__41870 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41870,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41870,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41870,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41870,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41870,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41870,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__41875 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41875,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41875,(1),null);
var vec__41878 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41878,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41878,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__41882 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__41882) : devtools.munging.parse_fn_info_deep.call(null,G__41882));
})()));
}
} else {
return fn_info;
...
var G__42057 = (arity + (1));
var G__42058 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41897_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__41897_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41898_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__41898_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___42060 = arguments.length;
var i__4737__auto___42061 = (0);
while(true){
if((i__4737__auto___42061 < len__4736__auto___42060)){
args__4742__auto__.push((arguments[i__4737__auto___42061]));

var G__42062 = (i__4737__auto___42061 + (1));
i__4737__auto___42061 = G__42062;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__41901){
var vec__41902 = p__41901;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41902,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq41899){
var G__41900 = cljs.core.first(seq41899);
var seq41899__$1 = cljs.core.next(seq41899);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41900,seq41899__$1);
}));
...
var map__41910 = options;
var map__41910__$1 = (((((!((map__41910 == null))))?(((((map__41910.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__41910.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__41910):map__41910);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41910__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41910__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41910__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41910__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__41911 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41911,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41911,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41911,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41911,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41911,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41911,(5),null);
...
var o__41062__auto__ = f;
return (o__41062__auto__["getBasis"]).call(o__41062__auto__);
});
/**
...
}catch (e41921){var _e__41078__auto__ = e41921;
...
var G__42081 = (obj[cljs.core.first(path)]);
var G__42082 = cljs.core.rest(path);
obj = G__42081;
path = G__42082;
continue;
} else {
...
var _STAR_ = (function (accum,p__41929){
var vec__41930 = p__41929;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41930,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41930,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__41939){
var vec__41940 = p__41939;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41940,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41940,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41940,(2),null);
...
var post_process = (function (p__41948){
var vec__41949 = p__41948;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41949,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41949,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41944_SHARP_){
return (obj[cljs.core.first(p1__41944_SHARP_)]);
}),sorted_matches);
